...
const dict = {
  en: {
    ...
    "sidebar.recursivePlay": "View all",
    "sidebar.recursiveActive": "Viewing all",
    "sidebar.loading": "Loading...",
    "sidebar.empty": "No images in this folder",
    ...
    "shortcuts.toggleSlideshow": "Toggle slideshow",
    ...
    "shortcuts.copyImage": "Copy image to clipboard",
    "shortcuts.rotateCw": "Rotate clockwise 90\u00b0",
    "shortcuts.rotateCcw": "Rotate counterclockwise 90\u00b0",
    "shortcuts.moveToTrash": "Move to trash",
    "shortcuts.exitImmersive": "Exit immersive mode",
    "shortcuts.toggleImmersive": "Toggle immersive mode",
    "shortcuts.showHelp": "Show this help panel",
    "shortcuts.modifier": "Cmd",
    "confirm.delete.title": "Move to Trash",
    "confirm.delete.single": "Are you sure you want to move this image to the Trash?",
  ...
  zh: {
    ...
    "sidebar.recursivePlay": "查看全部",
    "sidebar.recursiveActive": "查看中",
    "sidebar.loading": "加载中...",
    "sidebar.empty": "此文件夹中没有图片",
    ...
    "shortcuts.prevNext": "上一张 / 下一张",
    "shortcuts.toggleSlideshow": "切换幻灯片",
    "shortcuts.toggleFullscreen": "切换全屏",
    "shortcuts.zoomIn": "放大",
    "shortcuts.zoomOut": "缩小",
    "shortcuts.resetZoom": "重置缩放",
    "shortcuts.toggleSidebar": "切换侧边栏",
    "shortcuts.copyImage": "拷贝图片到剪贴板",
    "shortcuts.rotateCw": "顺时针旋转 90\u00b0",
    "shortcuts.rotateCcw": "逆时针旋转 90\u00b0",
    "shortcuts.moveToTrash": "移到废纸篓",
    "shortcuts.exitImmersive": "退出沉浸模式",
    "shortcuts.toggleImmersive": "切换沉浸模式",
    "shortcuts.showHelp": "显示快捷键帮助",
    "shortcuts.modifier": "Cmd",
    "confirm.delete.title": "移到废纸篓",
    "confirm.delete.single": "确定要将这张图片移到废纸篓吗？",
